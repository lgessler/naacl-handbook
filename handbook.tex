...
% for each part of the conference, add the .bib file
...
\setdaydateyear{Friday}{June 13}{2024}
\input{content/mexican_nlp/day1}

\setdaydateyear{Saturday}{June 14}{2024}
\input{content/mexican_nlp/day2}

%% TUTORIALS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\setdaydateyear{Sunday}{June 15}{2024}
...
\setdaydateyear{Monday}{June 16}{2024}
\input{content/day1/day1}

\setdaydateyear{Tuesday}{June 17}{2024}
\input{content/day2/day2}

\setdaydateyear{Wednesday}{June 18}{2024}
\input{content/day3/day3}

%% WORKSHOPS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% \setdaydateyear{Thursday--Friday}{June 19--20}{2024}
...
\input{content/venue-info/venue-info.tex}
